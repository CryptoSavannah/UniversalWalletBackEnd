...
def sign_up_email(first_name):
    return "Hey {} \n Welcome to binusu.com. You can now proceed to transact in crypto. Supported coins are BTC, ETH, LTC, XRP. Please reach out to support@binusu.com for further details".format(first_name)
