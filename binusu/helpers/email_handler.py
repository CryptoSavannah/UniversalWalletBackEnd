...
def buy_email(order_number, order_type, crypto_type, fiat_type, order_amount_crypto, order_amount_fiat, crypto_unit_price, email_address, phone_number):
    return "Order No. {}, \n type: {}, \n of crypto {}{} using {}{} at market price of {} per {}. Client Email address is {} and Phone Number is {}".format(order_number, order_type, order_amount_crypto, crypto_type, order_amount_fiat, fiat_type, crypto_unit_price, crypto_type, email_address, phone_number)

def client_email(order_number, order_type, crypto_type, fiat_type, order_amount_crypto, order_amount_fiat, crypto_unit_price):
    return "Order No. {}, \n type: {}, \n of crypto {}{} \n using {}{} at market price of {} per {} confirmed. Please hold on as one of our agents contacts you.".format(order_number, order_type, order_amount_crypto, crypto_type, order_amount_fiat, fiat_type, crypto_unit_price, crypto_type)

def sell_email(order_number, order_type, crypto_type, fiat_type, order_amount_crypto, order_amount_fiat, crypto_unit_price, email_address, phone_number):
    return "Order No. {}, type: {}, of crypto {}{} for {}{} at market price of {} per {}. Client Email address is {} and Phone Number is {}".format(order_number, order_type, order_amount_crypto, crypto_type, order_amount_fiat, fiat_type, crypto_unit_price, crypto_type, email_address, phone_number)
...
def sign_up_email(first_name):
    return "Hey {} \n Welcome to binusu.com. You can now proceed to transact in crypto. Supported coins are BTC, ETH, CELO, cUSD. Please reach out to support@binusu.com for further details".format(first_name)
